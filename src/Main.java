...
public class Main {
  ...
  // The time complexity is:
  // YOUR ANSWER HERE: O(n) if there was not a fixed array; O(1) because only 3 passwords
  ...
  // The time complexity is:
  // YOUR ANSWER HERE: O(n), computeProducts method is O(n)
  ...
  // of the array
  // O(n^2), computeFactorial is O(n) so nested loop is O(n^2)
  ...
  // The time complexity is:
  // YOUR ANSWER HERE: O(n), the contains method for lists is O(n)
